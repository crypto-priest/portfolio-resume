  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <nav className="w-full backdrop-blur-sm bg-[var(--bg)]/80 sticky top-0 z-50 border-b border-[var(--border)]">
        <div style={{ maxWidth: '1000px', margin: '0 auto' }} className="px-4 sm:px-6 md:px-8 py-3 sm:py-4">
          <div className="flex justify-between items-center gap-3 sm:gap-4">
            <h1 className="text-lg sm:text-xl font-bold">
              <a href="/" className="text-[var(--accent)] hover:text-[var(--accent-hover)]">
                <span className="text-[var(--text-muted)] mr-1 sm:mr-2">$</span>mahavirdash
              </a>
            </h1>
      ...
      {/* Main Content */}
      <main style={{ maxWidth: '1000px', margin: '0 auto' }} className="px-4 sm:px-6 md:px-12 py-8 sm:py-12 md:py-20">
